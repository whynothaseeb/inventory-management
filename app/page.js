...
const handleClose = () => setOpen(false)
  ...
  return (
    <Box 
      ...
      <Box width="800px" height="100px" justifyContent="center">
      <TextField variant="outlined" placeholder="Search Items..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} fullWidth margin="normal" />
      </Box>
      <Box border="1px solid #333">
        ...
        height="100px" 
        bgcolor="#ADD8E6">
          <Typography variant = 'h2' color='#333' display="flex" justifyContent="center" a lignItems="center">Inventory Items</Typography>
        </Box>
